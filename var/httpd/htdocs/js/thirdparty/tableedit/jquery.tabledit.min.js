...
//                        var span = '<span class="tabledit-span tabledit-identifier">' + $(this).text() + '</span>';
                        var span = '<span class="tabledit-span tabledit-identifier">' + $(this).html() + '</span>';
// EO Complemento
...
//            var serialize = $table.find('.tabledit-input').serialize() + '&action=' + action;
            var serialize = $table.find('.tabledit-input').serialize() + '&Subaction=' + action;
			serialize += '&ConfigItemID='+$table.find('.tabledit-edit-mode').first().parent().attr('data-cmdb-id');
			serialize += '&Changed='+($('input, select',td).attr('name'));
